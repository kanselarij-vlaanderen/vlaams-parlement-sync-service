import { DOMAIN, VP_API_CLIENT_ID, VP_API_CLIENT_SECRET, VP_ERROR_EXPIRE_TIME } from '../config';
...
class VP {
   ...
   */
  generatePayload(decisionmakingFlow, pieces, comment=undefined, contact, subcaseTitle) {
