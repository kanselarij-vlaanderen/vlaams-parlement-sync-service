 ...
 */
async function getIncompleteParliamentFlows() {
  const queryString = `
PREFIX parl: <http://mu.semte.ch/vocabularies/ext/parlement/>
...
WHERE {
  VALUES ?status {
    <http://themis.vlaanderen.be/id/parlementaireaangelegenheid-status/d30fdd4d-ba47-437d-b72e-4bff02e8c3fb>
    <http://themis.vlaanderen.be/id/parlementaireaangelegenheid-status/018fb31c-44ad-4bf5-b01b-76de2d48abf4>
  }
 ...
 */
async function updateParliamentFlowStatus(parliamentFlowUri, statusUri, updateSudo=false) {
  const queryString = `
PREFIX dossier: <https://data.vlaanderen.be/ns/dossier#>
PREFIX parl: <http://mu.semte.ch/vocabularies/ext/parlement/>
PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
...
INSERT {
  ...
  const updateFunc = updateSudo ? updateSudo : update;
